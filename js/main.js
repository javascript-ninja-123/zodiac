...
if($(this).val() ==""){
	...
	$(this).val("Enter your horoscope sign");
}
...
if(zodiac[i].sign == sign.toLowerCase()){
$(".name").text(sign.toLowerCase());
$(".image").attr("src",zodiac[i].image);
$(".fortune").text(zodiac[i].fortune);
